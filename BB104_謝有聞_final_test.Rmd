...
load("C:/Users/Java/riii/final/lvr_prices_big5.RData")
```
...
#hint3: 將運算完的資料轉為整數型態(integer) [8分]
 ...
 building_age=round(Sys.Date()-house$finish_ymd)
...
#     存回house變數中 [5分]
load("C:/Users/Java/riii/final/house_danger.RData")
house=merge(x=house,y=house_danger,by="ID",all.x = T)
```
...
set.seed(1206)
ind=sample(2, nrow(house), replace = T, prob = c(0.8,0.2))
